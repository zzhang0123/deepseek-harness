// Web e2e: the ui-brand client bundle is served and registered in the
...
describe('web e2e: rheplicant ui-compute bundle loads', () => {
  ...
  it('lists the ui-brand plugin in the browser boot roster', async () => {
    ...
    expect(roster).toContain('@deepseek-ai/dsh-client-rheplicant-ui-brand')
  })
})
